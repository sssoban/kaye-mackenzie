...
const WhyUsComponent = () => {
  return (
    <div className="text-left flex flex-col gap-5 sm:gap-10 px-5 sm:px-0 mt-40">
      <div>
        <p className="text-[#5C2F88] sm:text-3xl tracking-[20px] font-inter font-medium">
          Why Us
        </p>
        <p className="text-[#444444] text-4xl sm:text-[82px] tracking-[15px] sm:tracking-[20px] font-bold">Why Us</p>
      </div>
